...
def setup(args):
    ...
    cfg.MODEL.WEIGHTS = '/home/asd/Project/BridgeDetection/Faster-RCNN-Trainer/output_bk/model_0069999.pth'
    cfg.freeze()
    default_setup(
        cfg, args
...
def cocoEval(VAL_IMGS, VAL_GT, PREDICT_JSON):
    ...
    coco_pred = coco_gt.loadRes(PREDICT_JSON)
                ...
                if group_results["mean_score"].mean() < 0.8:
                    ...
                    for _, result in group_results.iterrows():
                        ...
                        if os.path.exists(xml_name):
                            ...
                            saveGaofenXMLFormat(xml_name, im_name, boxes, scores)
    # print(coco_list)
    with open('./Faster-RCNN-Trainer/data.json', 'w') as f:
        f.write(str(coco_list).replace("'", '"').replace('"category_id": 0', '"category_id": 1'))
    # mAP
    VAL_IMGS = images_dir
    VAL_GT = "/home/asd/Mission/GaoFen/bridge_new/data/data_wenhe_gai/aug/test/coco/bridge_test_cocostyle.json"
    PREDICT_JSON = "./Faster-RCNN-Trainer/data.json"
    cocoEval(VAL_IMGS, VAL_GT, PREDICT_JSON)
...
if __name__ == "__main__":
    ...
    ioParser.add_argument('--in_path', type=str,help='输入图片路径', default=r"/home/asd/Mission/GaoFen/bridge_new/data/data_wenhe_gai/aug/test/images")
    ioParser.add_argument('--out_path', type=str,help='输出xml路径', default=r"/home/asd/Mission/GaoFen/bridge_new/data/data_wenhe_gai/aug/test/images")
